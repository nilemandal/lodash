...
// console.log('console log difference', _.difference(newArr,[1,0,7]));
// Creates an array of array values not included in the other given arrays using SameValueZero for equality comparisons. The order and references of result values are determined by the first array.

// console.log('console log drop' , _.drop(newArr,2) , _.dropRight(newArr,2))
...
// console.log('console log union' , _.union( newArr, _.flattenDeep(numberArr)));
...
// zipObject except that it accepts two arrays, one of property identifiers and one of corresponding values.
...
// console.log('console log nth', _.nth(newArr,3));
